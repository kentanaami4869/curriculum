...
-- [回答]
SELECT * FROM stock_table JOIN goods_table,store_table ON stock_table.quantity = goods_table.goods_name,store_table.store_name
...
-- [回答]
SELECT quantity, quantity FROM stock_table
 WHERE EA01 > (SELECT AVG(quantity) FROM Goods)
